...
The parser reads the whole grammar. Lowering to `ir` has started; `docs/design/ir-plan.md` phases 1 through 6 are done. Phase 6b is the conditional instance search and phase 7 is constraints and defaults.
