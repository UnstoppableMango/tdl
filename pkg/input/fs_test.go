...
var _ = Describe("Fs", func() {
	...
	It("should create a new file", func() {
		actual, err := input.Fs(fsys, "thing.txt")
	...
	Describe("ParseArgs", func() {
		It("should work", func() {
			...
			actual, err := input.ParseArgs(fsys, []string{"not important", "dir"})
		...
		It("should not support three args", func() {
			_, err := input.ParseArgs(fsys, []string{"fdh", "fdj", "fdkjs"})
