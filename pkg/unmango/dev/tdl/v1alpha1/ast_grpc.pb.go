...
const (
	Parser_Parse_FullMethodName = "/unmango.dev.tdl.v1alpha1.Parser/Parse"
)
...
var Parser_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "unmango.dev.tdl.v1alpha1.Parser",
	...
	Metadata: "unmango/dev/tdl/v1alpha1/ast.proto",
}
